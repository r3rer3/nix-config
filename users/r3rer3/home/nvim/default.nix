    ...
    plugins = with pkgs.vimPlugins; [
      ...
      (pkgs.vimUtils.buildVimPlugin {
        ...
        src = pkgs.fetchFromGitHub {
          owner = "neovim";
          repo = "nvim-lspconfig";
          rev = "bc09aa236d7d2af66f56a5a35d0577588eca7800";
          hash = "sha256-8puQc0zuRTzXWjf+mrzptviF7DzLBedrjO0k8G1sOvU=";
        };
      })
      ...
      (pkgs.vimUtils.buildVimPlugin {
        ...
        src = pkgs.fetchFromGitHub {
          ...
          repo = "none-ls.nvim";
          rev = "main";
          hash = "sha256-T/MG/4Y0oV6GKmNg1FdDQTavSQd+HMJIPpWkaJd6DL8=";
        };
      })
      ...
      (pkgs-unstable.vimPlugins.avante-nvim.overrideAttrs (oldAttrs: {
        src = pkgs.fetchFromGitHub {
          owner = "yetone";
          repo = "avante.nvim";
          rev = "178b62a180e9c599a1846b28ac34a23abde0e973";
          hash = "sha256-hUOUtxuYOGvIWB58ZCyFHOXBtSJC5H89LQkXYy1ziAQ=";
        };
      ...
      (pkgs.vimUtils.buildVimPlugin {
        ...
        src = pkgs.fetchFromGitHub {
          ...
          rev = "main";
          hash = "sha256-nQFsciO8LgAtawU96Q8wWJjF5K8Fbm6Uepw9jSlLMyE=";
        };
      })
      ...
      (pkgs.vimUtils.buildVimPlugin {
        ...
        src = pkgs.fetchFromGitHub {
          ...
          repo = "cornelis";
          rev = "master";
          hash = "sha256-eL6C5vkWDkpWardA84XwjTdd8BzFpYFJAkIa9OpuSk0=";
        };
      })
