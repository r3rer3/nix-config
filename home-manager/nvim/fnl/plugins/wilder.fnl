(let [wilder (require :wilder)]
  ...
  (wilder.set_option :pipeline
                     [(wilder.branch (wilder.cmdline_pipeline {:fuzzy 2
                                                               :fuzzy_filter (wilder.lua_fzy_filter)})
                                     (wilder.python_search_pipeline {:pattern (wilder.python_fuzzy_pattern {:start_at_boundary 0})}))])
  (wilder.set_option :renderer
                     (wilder.renderer_mux {":" (wilder.popupmenu_renderer (wilder.popupmenu_border_theme {:highlighter (wilder.lua_fzy_highlighter)
                                                                                                          :pumblend 20
